  ...
  >
    ...
    <div class="">
      <div class="flex-grid" v-for="item in table.items" track-by="id">
        <div class="grid-cell c-label center">{{item.grade}}</div>
        <div class="grid-cell center">{{item.title}}</div>
        <div class="grid-cell">{{item.termName}}</div>
        <div class="grid-cell">{{item.enrollYear}}</div>
        <div class="grid-cell">{{item.status | get_const_value 'status'}}</div>
